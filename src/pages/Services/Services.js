...
const THUMB_SIZE = 60;
const MAX_VISIBLE = 6;
const MAX_HEIGHT = THUMB_SIZE * MAX_VISIBLE;
    ...
    const fetchService = () => {
        setLoading(true);
        axios
            .get(`${url}/service/services?search=${onsearchText}&page=${currentPage + 1}&page_size=${rowsPerPage}`, {
                headers: {
        ...
        axios
            ...
            .catch((error) => {
                ...
                axios.post(`${url}/api/token/refresh/`, { refresh }).then((res) => {
                    ...
                    axios
                        .get(`${url}/auth/service/services/?data=list`, { headers: new_headers })
                        .then((res) => {
                            SetServiceID(res.data);
                        });
                });
    ...
    return (
        <PageContainer title="Service Posts" description="Service Posts">
                                    ...
                                    {loading ? (
                                        ...
                                        serviceList.map((item, index) => (
                                            ...
                                            >
                                                ...
                                                <TableCell align="center">{item.service_category.name}</TableCell>
                                    ...
                                    <Grid container spacing={4} sx={{ marginTop: "20px" }}>
                                        ...
                                        <Grid item xs={12} md={8}>
                                            ...
                                            <Grid container spacing={2}>
                                                ...
                                                <Grid item xs={6}>
                                                    <Box mb={2}>
                                                        ...
                                                        >
                                                            <Typography variant="body2">
                                                                {ServiceID.currency} {ServiceID.base_price}
                                                            </Typography>
                                                        </Box>
                                                    </Box>
                                                </Grid>
                                            ...
                                            <Box mb={3}>
                                                ...
                                                >
                                                    <Typography variant="body2">
                                                        {ServiceID.is_current ? 'Active' : 'Inactive'}
                                                    </Typography>
                                                </Box>
                                            </Box>

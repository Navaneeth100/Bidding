...
const Customer = () => {
    ...
    const fetchSubCustomer = () => {
        setLoading(true);
        axios
            .get(`${url}/auth/vendor-customer/?user_type=Customer&data=sub&search=${onsearchText}&page=${currentPage + 1}&page_size=${rowsPerPage}`, {
                headers: {
    ...
    return (
        <PageContainer title="Customer List" description="Customer List">
